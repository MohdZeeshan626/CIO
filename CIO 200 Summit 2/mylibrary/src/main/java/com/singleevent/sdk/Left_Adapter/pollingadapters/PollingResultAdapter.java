...
public class PollingResultAdapter extends RecyclerView.Adapter<PollingResultAdapter.myViewHolder> {
    Context context;
    List<PollingResultPojo> resultPojos;

    public PollingResultAdapter(Context context, List<PollingResultPojo> resultPojos) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PollingResultAdapter.myViewHolder(view);
    }
