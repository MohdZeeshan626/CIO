package com.singleevent.sdk.View.RightActivity.admin.adminSurvey.adapter;
...
public class AttendeeUserListAdapter extends RecyclerView.Adapter<AttendeeUserListAdapter.ViewHolder> {
    ...
    public AttendeeUserListAdapter(Context context, List<User> myDataset) {
        eventUserList = myDataset;
        AttendeeUserListAdapter.context1 = context;
        Paper.init(context);
//        userid = DataBaseStorage.decrypt(Paper.book().read("userId",""));
    ...
    public ViewHolder onCreateViewHolder(final ViewGroup parent,
        ...
        View v = LayoutInflater.from(context1)
                .inflate(R.layout.s_userlist_attendee_row, parent, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        void setItem(User user) {
            try {
                ...
                if (user.getCompany() != null && !user.getCompany().isEmpty()&& !user.getCompany().equals("")) {
                    city.setText(user.getCompany());
                }
                else{
                    city.setText("");
                }
