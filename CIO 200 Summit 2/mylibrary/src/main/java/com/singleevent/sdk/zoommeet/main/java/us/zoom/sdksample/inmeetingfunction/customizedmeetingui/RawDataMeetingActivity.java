...
import com.singleevent.sdk.zoommeet.main.java.us.zoom.sdksample.inmeetingfunction.customizedmeetingui.rawdata.AudioRawDataUtil;
import com.singleevent.sdk.zoommeet.main.java.us.zoom.sdksample.inmeetingfunction.customizedmeetingui.rawdata.RawDataRender;
import com.singleevent.sdk.zoommeet.main.java.us.zoom.sdksample.inmeetingfunction.customizedmeetingui.rawdata.UserVideoAdapter;
...
public class RawDataMeetingActivity extends FragmentActivity implements InMeetingServiceListener, MeetingServiceListener,  InMeetingShareController.InMeetingShareListener, View.OnClickListener, UserVideoAdapter.ItemTapListener {
    ...
    public void onClick(View v) {
            ...
            else if(v.getId()== R.id.big_video) {
...
//                changeResolution();
             ...
             else if(v.getId()== R.id.btn_switch_share) {
                if (currentShareUserId > 0) {
                    switchToShare.setVisibility(View.GONE);
             ...
             else if(v.getId()== R.id.btnSwitchCamera) {
