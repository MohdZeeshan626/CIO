...
public class ExhibitorLeadGenerationActivity extends AppCompatActivity implements View.OnClickListener{
    private static final int SCAN_QR_CODE_REQUEST = 2000;
    private static final String TAG = ExhibitorLeadGenerationActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exhibitor_lead_generation);
    ...
    protected void onResume() {
        super.onResume();
        toolbar.setTitle(Util.applyFontToMenuItem(ExhibitorLeadGenerationActivity.this,
    ...
    public void onClick(View v) {
        ...
        if (id== R.id.btn_add_lead_manually){
            ...
            checkCameraPermission();
                /*startActivityForResult(new Intent(this,ScanQrCodeActivity.class),SCAN_QR_CODE_REQUEST);*/
        }
    }
            ...
            if (resultCode==RESULT_OK){
                ...
                if (data.getExtras() != null){
                    ...
                    if (leadid != null &&  ( ! leadid.equals(Paper.book().read("userId" ) )) )
                        ...
                        Error_Dialog.show(   "You can't add this user.",ExhibitorLeadGenerationActivity.this);
                    }
                }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(jsonObject.getBoolean("response")){
                        ...
                        Error_Dialog.show(   jsonObject.getString("responseString"),ExhibitorLeadGenerationActivity.this);
        ...
        switch (requestCode) {
            case ZBAR_CAMERA_PERMISSION:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    //Do something
                    Intent intent = new Intent(ExhibitorLeadGenerationActivity.this, ScanQrCodeActivity.class);
