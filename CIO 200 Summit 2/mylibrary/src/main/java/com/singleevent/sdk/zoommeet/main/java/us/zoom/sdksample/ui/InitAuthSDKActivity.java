...
import com.singleevent.sdk.zoommeet.main.java.us.zoom.sdksample.initsdk.InitAuthSDKCallback;
import com.singleevent.sdk.zoommeet.main.java.us.zoom.sdksample.initsdk.InitAuthSDKHelper;
import com.singleevent.sdk.zoommeet.main.java.us.zoom.sdksample.inmeetingfunction.customizedmeetingui.MyMeetingActivity;
import com.singleevent.sdk.zoommeet.main.java.us.zoom.sdksample.inmeetingfunction.customizedmeetingui.RawDataMeetingActivity;
...
public class InitAuthSDKActivity extends Activity implements InitAuthSDKCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mZoomSDK.isInitialized()) {
            mBtnEmailLogin.setVisibility(ZoomSDK.getInstance().isEmailLoginEnable() ? View.GONE : View.GONE);
    ...
    public void onClickJoin(View view) {
        ...
        params.meetingNo = id;//"86992434099";
        params.displayName = Paper.book().read("username","");
        params.password = pwd;//"ZnJRSTVyUXgrYjFKWE54V01tRFlBZz09";
