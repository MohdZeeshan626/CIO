package com.singleevent.sdk.gallery_camera.Helper;
...
public class PermissionHelper {
    ...
    public static void checkPermission(AppCompatActivity activity, String permission, PermissionAskListener listener) {
    ...
    public static void requestAllPermissions(@NonNull AppCompatActivity activity, @NonNull String[] permissions, int requestCode) {
        if (shouldAskPermission()) {
    ...
    private static void internalRequestPermissions(AppCompatActivity activity, String[] permissions, int requestCode) {
        if (activity == null) {
