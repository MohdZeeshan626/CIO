...
public class FeedQuizResultAdapter extends RecyclerView.Adapter<FeedQuizResultAdapter.myViewHolder> {
    Context context;
    List<PollingResultPojo> resultPojos;

    public FeedQuizResultAdapter(Context context, List<PollingResultPojo> resultPojos) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FeedQuizResultAdapter.myViewHolder(view);
    }
