...
public  class ContactUsFragment extends Fragment implements View.OnClickListener, UploadResultReceiver.Receiver {
    ...
    private RelativeLayout view1, view2, view3,save11;
    private Button camera_button, button_retake, button_send, camera_button2, ble_scan_btn, ble_scan_btn_1,SAVE;
    ...
    String f_fname,appid,f_lname,f_desc,f_addrs,f_company,f_desig,f_website,f_email,f_dtext,f_uemail,f_flag,f_itemflag,f_uid,f_phone,f_imageUrl;
    AppCompatActivity a;


    EditText tv_company,tv_designation,tv_address,tv_phone,tv_email,tv_website,tv_fax,tv_alt_phone,tv_altEmail,tv_altWebsite;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.contact_share, container, false);
        ...
        save11 =(RelativeLayout) view.findViewById(R.id.save11);
        ...
        imageview = (ImageView) view.findViewById(R.id.attachment2);
        //For upper Layout
...
/* user_login.setOnClickListener(new View.OnClickListener() {
    ...
    private void userLogin() {
        ...
        if (Paper.book().read("Islogin", false)) {
            ...
            i = new Intent(context, RegActivityDemo.class);
            i.setAction(ApiList.loginaction);
...
/*User_Details user_details = Paper.book().read("UserDetailsOffline");
    ...
    public void on_bluetooth() {
        ...
        if (!myBluetoothAdapter.isEnabled()) {
            ...
            Toast.makeText(getActivity().getApplicationContext(), "Bluetooth turned on",
        ...
        switch (requestCode) {
            ...
            case SCANNER_REQUEST_CODE:
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    String qrcode_userid = data.getStringExtra("content");
                    String arr =(qrcode_userid.substring(qrcode_userid.lastIndexOf("/") + 1));
                    String appid=appDetails.getAppId();
                    String loggedin_userid=Paper.book().read("userId", "");
                    shareQrCodeAPI(appid,qrcode_userid,loggedin_userid);
                    */
/*contactsArrayList.clear();
                    getContactsLists();*//*
    ...
    private void shareQrCodeAPI(String appid, String qrcode_userid,String loggedin_userid) {
...
/*  f_name = fname;
            ...
            f_uemail=Paper.book().read("Email_ID", "");;
        ...
        if (takePictureIntent.resolveActivity(getActivity().getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                photoURI = FileProvider.getUriForFile(getActivity(),
                        "com.webmobi.webmobitechconference2018.provider",
                        photoFile);
