...
/*import com.singleevent.sdk.LinkedinSDK.APIHelper;
import com.singleevent.sdk.LinkedinSDK.LISessionManager;
import com.singleevent.sdk.LinkedinSDK.errors.LIApiError;
import com.singleevent.sdk.LinkedinSDK.errors.LIAuthError;
import com.singleevent.sdk.LinkedinSDK.listeners.ApiListener;
import com.singleevent.sdk.LinkedinSDK.listeners.ApiResponse;
import com.singleevent.sdk.LinkedinSDK.listeners.AuthListener;
import com.singleevent.sdk.LinkedinSDK.utils.Scope;*/
...
//        linkedin.setBackgroundColor(Color.parseColor(appDetails.getTheme_color()));
        done.setBackground(Util.setdrawable(MyProfile.this, com.singleevent.sdk.R.drawable.healthpostbut,
    ...
    private void Getprofile(int n) {
        ...
        final ProgressDialog pDialog = new ProgressDialog(MyProfile.this, R.style.MyAlertDialogStyle);
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,
                ...
                try {
                    ...
                    if (jObj.getBoolean("response")) {
                        ...
                        if (jObj.getString("responseString").equalsIgnoreCase("Invalid token")) {
                            ...
                            Error_Dialog.show(jObj.getString("responseString"), MyProfile.this);
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof TimeoutError) {
                    ...
                    Error_Dialog.show(VolleyErrorLis.handleServerError(error, MyProfile.this), MyProfile.this);
    ...
    private void setprofilepic(String bm) {
        if (!bm.equalsIgnoreCase("")) {
            Paper.book().write("ProfilePIC", bm);
        }
    ...
    private void disablebutton() {
        ...
        //done.setBackground(Util.setdrawable(MyProfile.this, R.drawable.lead_gen_btn_bckg, res));
...
//        done.setTextColor((Color.parseColor("#ffffff") & 0x00ffffff));
    ...
    protected void onResume() {
        ...
        SpannableString s = new SpannableString("MyProfile");
    ...
    public void onClick(View view) {
        ...
        if (n == R.id.iv_edit_image) {
            android.app.AlertDialog.Builder myAlertDialog = new android.app.AlertDialog.Builder(
                    MyProfile.this, R.style.MyAlertDialogStyle);
        ...
        if (n == R.id.changewd) {
            ...
            Intent i = new Intent(MyProfile.this, ChangePwd.class);
            startActivity(i);
               /* Intent i=new Intent(MyProfile.this, TreloHome.class);
                 startActivity(i);*/
        }

        if (n == R.id.logout) {
            logout();
              /* Intent i=new Intent(MyProfile.this, SimpleMentions.class);
               startActivity(i);*/
                /*Intent intent=new Intent(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("http://player.vimeo.com/video/24577973?player_id=player&autoplay=1&title=0&byline=0&portrait=0&api=1&maxheight=480&maxwidth=800"));
                startActivity(intent);*/

//                Intent i=new Intent(MyProfile.this, LiveVideo.class);
//                startActivity(i);

             /*   Intent i=new Intent(MyProfile.this, InitAuthSDKActivity.class);
                startActivity(i);*/
        ...
        if (n == R.id.authenticate_facebook) {
            LoginManager.getInstance().logInWithReadPermissions(MyProfile.this, Arrays.asList("email", "public_profile"));
        }
        ...
        LoginManager.getInstance().registerCallback(callbackManagerFaceBook,
                new FacebookCallback<LoginResult>() {
                    ...
                    public void onSuccess(LoginResult loginResult) {
                        Toast.makeText(MyProfile.this, "Successfully Authenticated", Toast.LENGTH_SHORT).show();
...
//                        handleFacebookToken(loginResult.getAccessToken());
                    ...
                    public void onCancel() {
                        Toast.makeText(MyProfile.this, "Login Cancel", Toast.LENGTH_LONG).show();
                    }
...
//            Toast.makeText(getApplicationContext(), "Success", Toast.LENGTH_SHORT).show();
    ...
    protected void startWebAuthentication() {
        final Intent intent = new Intent(MyProfile.this, TwitterAuthentication.class);
...
//                pDialog.dismiss();
//                System.out.println(response);
//                Intent i = new Intent(MyProfile.this, LinkedinProfile.class);
//
//                finish();
//
//
...
//        ));
        ...
        Intent i = new Intent(MyProfile.this, LinkedInLoginActivity.class);
//        i.putExtra("Value", response);
        i.putExtra("directed_from","SettingProfile");
        startActivity(i);
        finish();
    }
...
//-------------LinkedIn code end--------------------//
    ...
    private void chooseImageFromGallery() {
        Dexter.withContext(MyProfile.this)
    ...
    private void logout() {
        ...
        final ProgressDialog dialog = new ProgressDialog(MyProfile.this, R.style.MyAlertDialogStyle);
    ...
    private void UpdatingProfile(int n) {
        ...
        final ProgressDialog dialog = new ProgressDialog(MyProfile.this, R.style.MyAlertDialogStyle);
        dialog.setMessage("Updating MyProfile...");
        dialog.show();
        ...
        if (requestCode == 121) {
            if (resultCode == Activity.RESULT_OK) {
                try {
                    ...
                    Bitmap b = modifyOrientation(selectedImage, imagepath);
    ...
    public void linkededinApiHelper() {
        ...
        apiHelper.getRequest(MyProfile.this, topCardUrl, new ApiListener() {
            @Override
    ...
    private void updateprofilepic(final String encodedImage) {
        ...
        final ProgressDialog dialog = new ProgressDialog(MyProfile.this, R.style.MyAlertDialogStyle);
        dialog.setMessage("Uploading MyProfile Pic...");
        dialog.show();
    ...
    ///Adding code for opt-in / opt-out
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof TimeoutError) {
                    ...
                    Error_Dialog.show(VolleyErrorLis.handleServerError(error, getBaseContext()), MyProfile.this);
                } else if (VolleyErrorLis.isNetworkProblem(error)) {
