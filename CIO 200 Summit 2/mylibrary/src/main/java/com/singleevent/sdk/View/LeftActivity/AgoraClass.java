...
public class AgoraClass extends AppCompatActivity implements VolleyResponseListener
{
    ...
    String role,group_id,token,group_name;
    boolean isAdmin;
...
/*
        ...
        if (extras == null)
            finish();
        agendadetails = (Agendadetails) getIntent().getSerializableExtra("AgendaList"); //
        ...
        if (tag.equals(CHECK_IN_REQ_TAG)) {
            ...
            if (response.getString("response").equals("success")) {
              ...
              //  Toast.makeText(this, Util.applyFontToMenuItem(this,
                ...
                args.putString("Agenda_id", agendaID);
                args.putSerializable("AgendaList",agendadetails);
                Intent i = new Intent(AgoraClass.this, MainActivity.class);
                i.putExtras(args);
...
*/
    ...
    public void addchatID() {
        ...
        final ProgressDialog dialog = new ProgressDialog(AgoraClass.this,R.style.MyAlertDialogStyle);
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                ...
                try {
                    ...
                    if (jObj.getBoolean("response")) {
                        ...
                        if (jObj.getString("responseString").equalsIgnoreCase("Invalid token")) {
                            ...
                            i.setClassName(AgoraClass.this.getPackageName(), AgoraClass.this.getPackageName()+".SessionExpired");
                            i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            AgoraClass.this.startActivity(i);

                        } else
                            Error_Dialog.show(jObj.getString("responseString"), AgoraClass.this);
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof TimeoutError) {
                    Error_Dialog.show("Timeout", AgoraClass.this);
                } else if (VolleyErrorLis.isServerProblem(error)) {
                    Error_Dialog.show(VolleyErrorLis.handleServerError(error, AgoraClass.this), AgoraClass.this);
                } else if (VolleyErrorLis.isNetworkProblem(error)) {
                    Error_Dialog.show("Please Check Your Internet Connection", AgoraClass.this);
                }
