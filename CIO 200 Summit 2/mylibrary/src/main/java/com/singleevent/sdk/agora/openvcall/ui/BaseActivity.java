...
import com.singleevent.sdk.agora.openvcall.model.*;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public final void joinChannel(final String channel, int uid) {
        ...
        if (TextUtils.equals(accessToken, "") || TextUtils.equals(accessToken, "null")) {
...
/*
    public final void joinChannel(final String channel, String uid) {
        String accessToken = getApplicationContext().getString(R.string.agora_access_token);
        if (TextUtils.equals(accessToken, "") || TextUtils.equals(accessToken, "null")) {
            accessToken = null; // default, no token
        }

        rtcEngine().joinChannelWithUserAccount(accessToken, channel, uid);
