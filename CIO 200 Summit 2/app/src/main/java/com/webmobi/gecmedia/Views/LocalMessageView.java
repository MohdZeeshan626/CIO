...
public class LocalMessageView extends AppCompatActivity {
    Context context;
    ChatMSG user;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(com.singleevent.sdk.R.id.chat_list_view);
        mInputMessageView = (EditText) findViewById(com.singleevent.sdk.R.id.chat_edit_text1);
        sendButton = (ImageView) findViewById(com.singleevent.sdk.R.id.enter_chat1);

        //initializing adapter

        chatArrayAdapter = new MessagesAdapter(context, Color.parseColor("#0a6a99"));
        ...
        HashMap<String, JSONObject> newmessages = Paper.book(appid).read("Message", new HashMap<String, JSONObject>());
        if (newmessages.containsKey(user.getSender_id())) {
            newmessages.remove(user.getSender_id());
            Paper.book(appid).write("Message", newmessages);
        }
    }
    ...
    private void Loadingdata() {
        ...
        String url = ApiList.ChatHistory + appid + "&user_id=" + UserID + "&recipient_id=" + user.getSender_id() + "&chat_type=single";
        Log.d("url is", url);
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,
                ...
                try {
                    ...
                    if (jObj.getBoolean("response")) {
                        ...
                        if (jObj.getString("responseString").equalsIgnoreCase("Invalid token")) {
                            Error_Dialog.show("Session is Expired Please Login", LocalMessageView.this);


                        } else
                            Error_Dialog.show(jObj.getString("responseString"), LocalMessageView.this);
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof TimeoutError) {
                    Error_Dialog.show("Timeout", LocalMessageView.this);
                } else if (VolleyErrorLis.isServerProblem(error)) {
                    Error_Dialog.show(VolleyErrorLis.handleServerError(error, context), LocalMessageView.this);
                } else if (VolleyErrorLis.isNetworkProblem(error)) {
                    Error_Dialog.show("Please Check Your Internet Connection", LocalMessageView.this);
                }
            }
        }) {
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put("token", Paper.book(appid).read("token", ""));
                return headers;
            }
        };
    ...
    private Emitter.Listener onConfirm = new Emitter.Listener() {
        ...
        public void call(Object... args) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Error_Dialog.show("Connected", LocalMessageView.this);
                }
            });
        }
    };
    ...
    private void attemptSend() {
        ...
        Intent chatIntent = new Intent("com.local.msg." + appid);
    ...
    private final TextWatcher watcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
            if (mInputMessageView.getText().toString().equals("")) {
                ...
                sendButton.setImageResource(com.singleevent.sdk.R.drawable.ic_chat_send);
        ...
        public void afterTextChanged(Editable editable) {
            if (editable.length() == 0) {
                ...
                sendButton.setImageResource(com.singleevent.sdk.R.drawable.ic_chat_send_active);
            }
        }
    };
    ...
    protected void onResume() {
        ...
        LocalBroadcastManager.getInstance(context).registerReceiver(broadcastReceiver, new IntentFilter("com.mychats." + appid + "." + user.getSender_id()));
