...
/**
 * Created by webMOBI on 4/6/2018.
 */
...
import com.webmobi.gecmedia.LocalDatabase.SharedPrefManager;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private void launchHomeScreen() {
        ...
        */
        Intent sending;
        /*sending = new Intent(WelcomeActivity.this, HomeScreen.class);
        sending.putExtra("EVENT_ID", event_id);
        ...
        if (Paper.book().read("Islogin", false)) {
            ...
            sending = new Intent(WelcomeActivity.this, RegActivity.class);
            startActivity(sending);
            finish();
        }
    }
