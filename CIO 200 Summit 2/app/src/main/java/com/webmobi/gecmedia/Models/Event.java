...
public class Event implements Serializable {
    ...
    public String getMultievent_type() {
        return multievent_type;
    }

    public void setMultievent_type(String multievent_type) {
        this.multievent_type = multievent_type;
    }
